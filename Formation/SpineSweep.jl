...
function spinesweep(sys::Int, parameters::Tuple, neighbours::Array;
    ...
    if sys in path
        ...
        order = Dict(i=>findall(x->x==i, path) for i in links)
    ...
    while true
        ...
        if SOLVER
            ...
            if NODE
                ...
                remotecall_fetch(wait, sender, getfield(Main, :relay))
